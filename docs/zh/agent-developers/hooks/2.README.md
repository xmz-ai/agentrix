...
*   [使用前工具 & 使用后工具](5.pre-tool-use.md) \- 控制和监控工具执行

**会话生命周期** :

*   [会话钩子](7.session-hooks.md) \- SessionStart, SessionEnd, UserPromptSubmit, Stop, SubagentStop

**系统事件** :

*   [预压缩](5.pre-tool-use.md#precompact) \- 上下文管理
*   [通知](5.pre-tool-use.md#notification) \- 系统通知

### 全面指南

*   [概述](1.overview.md) \- 钩子概念和架构
...
请参考[开发指南](3.development-guide.md)进行完整设置。
...
参见[示例](8.examples.md)了解更多模式。

## 类型安全

Claude 钩子输入类型由 `@anthropic-ai/claude-agent-sdk` 提供：
