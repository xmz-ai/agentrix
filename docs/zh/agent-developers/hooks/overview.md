...
参见[开发指南 - 使用 AgentrixContext](./development-guide.md#using-agentrixcontext-in-hooks) 获取完整文档。
...
*   [RepositoryInit](./repository-init.md) - 仓库初始化钩子
*   [PreToolUse & PostToolUse](./pre-tool-use.md) - 工具控制钩子
*   [Examples](./examples.md) - 真实世界模式

## 相关文档

*   [Agent Structure](../agent-structure.md) - 钩子目录结构
*   [Configuration](../configuration.md) - 在配置中启用钩子
