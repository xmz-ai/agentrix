...
*   [SessionStart](7.session-hooks.md#sessionstart) - 会话初始化
*   [PreToolUse](5.pre-tool-use.md) - 控制工具执行

## 相关文档

*   [Hook Overview](1.overview.md) - 钩子概念
*   [开发指南](3.development-guide.md) \- TypeScript 配置
*   [示例](8.examples.md) \- 更多模式
