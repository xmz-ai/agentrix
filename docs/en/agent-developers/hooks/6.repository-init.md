...
- [SessionStart](7.session-hooks.md#sessionstart) - Session initialization
- [PreToolUse](5.pre-tool-use.md) - Control tool execution

## Related Documentation

- [Hook Overview](1.overview.md) - Hook concepts
- [Development Guide](3.development-guide.md) - TypeScript setup
- [Examples](8.examples.md) - More patterns
