...
1. **[Install Dependencies](2.cli-setup-dependencies.md)**
   - System requirements
...
1. **[Dependency Troubleshooting](3.cli-dependency-troubleshooting.md)**
...
- [Agent Developers Guide](../agent-developers/1.overview.md) - Build custom agents
...
1. [Install Dependencies](2.cli-setup-dependencies.md)
2. [Troubleshoot if needed](3.cli-dependency-troubleshooting.md)
